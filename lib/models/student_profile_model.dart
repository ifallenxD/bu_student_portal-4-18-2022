class StudentProfile {
  ...
  StudentProfile.fromJson(Map<String, dynamic> json)
      : id = json['id'],
        ...
        studp_nationality = json['studp_nationality'] ?? 'n/a',
        studp_alternate_email_address =
            json['studp_alternate_email_address'] ?? 'n/a',
        studp_mobile_no = json['studp_mobile_no'] ?? 'n/a',
        studp_place_of_birth = json['studp_place_of_birth'] ?? 'n/a',
        studp_current_houseno_street =
            json['studp_current_houseno_street'] ?? 'n/a',
        studp_current_barangay = json['studp_current_barangay'] ?? 'n/a',
        studp_current_town_city = json['studp_current_town_city'] ?? 'n/a',
        studp_current_zipcode = json['studp_current_zipcode'] ?? 'n/a',
        studp_current_province = json['studp_current_province'] ?? 'n/a',
        studp_father_name = json['studp_father_name'] ?? 'n/a' ?? 'n/a',
